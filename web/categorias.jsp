...
<head>
    ...
    <title>Categorías - hiperInventorySolutions</title>
    ...
    <aside class="sidebar">
        ...
        <nav>
            <ul class="sidebar-nav">
                ...
                <li><a href="categorias.jsp" class="active"><i class="fas fa-tags"></i>Categorías</a></li>
                ...
                <li><a href="reportes.jsp"><i class="fas fa-file-csv"></i>Reportes</a></li>
    ...
    <div class="main-layout">
        <header class="topbar">
            <div class="topbar-left">
                ...
                <h2 class="topbar-title">Categorías</h2>
            </div>
        ...
        <main class="main-content">
            <div class="card">
                <div class="card-header">
                    ...
                    <button class="btn-primary"><i class="fas fa-plus"></i> Nueva Categoría</button>
                </div>
                <div class="card-empty">
                    <i class="fas fa-tools"></i>
                    <div>Módulo de Categorías en desarrollo</div>
                </div>
            </div>
        </main>
    </div>
