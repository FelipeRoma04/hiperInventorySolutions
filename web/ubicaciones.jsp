    ...
    <aside class="sidebar">
        ...
        <nav>
            <ul class="sidebar-nav">
                ...
                <li><a href="ubicaciones.jsp" class="active"><i class="fas fa-map-location-dot"></i>Ubicaciones</a></li>
        ...
        <main class="main-content">
            <div class="card">
                <div class="card-header">
                    ...
                    <button class="btn-primary"><i class="fas fa-plus"></i> Nueva Ubicación</button>
                </div>
                <div class="card-empty">
                    <i class="fas fa-map-marker-alt"></i>
                    <div>Módulo de Ubicaciones en desarrollo</div>
                </div>
            </div>
        </main>
    </div>
