...
<head>
    ...
    <title>Gestión de Categorías - hiperInventorySolutions</title>
...
<body>
    ...
    <div class="main-layout">
        <header class="topbar">
            <div><button class="hamburger"><i class="fas fa-bars"></i></button><h2 class="topbar-title">Categorías</h2></div>
