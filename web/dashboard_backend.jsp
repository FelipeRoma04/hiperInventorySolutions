...
<body>
    ...
    <main class="main-content">
        ...
        <div class="content">
            ...
            <div class="backend-info">
                <h2>🔧 Fase 3: Backend Java REST API</h2>
    ...
    <script>
        ...
        async function testAssetAPI() {
            const response = await fetch('/GlobanInventorySolutions/api/assets');
        ...
        async function testAssetStats() {
            const response = await fetch('/GlobanInventorySolutions/api/assets/stats');
            const data = await response.json();
            displayResponse(data);
        }
        ...
        async function testLowStock() {
            const response = await fetch('/GlobanInventorySolutions/api/assets/low-stock');
            const data = await response.json();
            displayResponse(data);
        }
        ...
        console.log('✅ Fase 3 Dashboard cargado - Backend REST activo');
    </script>
</body>
</html>
